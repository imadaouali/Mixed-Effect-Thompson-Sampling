#!/usr/bin/env python
"""MovieLens linear bandit experiment."""
...
def main():
    ...
    ap.add_argument("--als_d", type=int, default=5, help="ALS embedding dimension")
    ...
    for _ in range(args.num_runs):
        ...
        env = CoBandit(args.K, contexts, Theta, sigma=args.sigma)
        env.A = A
        env.mu_psi = mu_psi
    ...
    if args.save:
        ...
        save_path = os.path.join(
            args.save, "lin_movielens_K%d_L%d_d%d.png" % (args.K, args.L, args.d)
        )
