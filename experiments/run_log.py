#!/usr/bin/env python
"""Synthetic logistic bandit experiment."""
...
from algorithms.logistic import meTS, FactoredmeTS, LinmeTS, LogTS, UCBLog, HierTS
...
def main():
    ...
    title = "Log Bandit, K = %d, L = %d, d = %d" % (args.K, args.L, args.d)
    save_path = None
    if args.save:
        os.makedirs(args.save, exist_ok=True)
        save_path = os.path.join(
            args.save, "log_K%d_L%d_d%d.png" % (args.K, args.L, args.d)
        )
